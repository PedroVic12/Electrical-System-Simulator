...
class MainWindow(QMainWindow):
    ...
    def on_build_network(self):
        # allow user edits in tabs to override model.dataframes
        ui_dfs = {}
        ...
        # progress dialog for heavy build
    ...
    def render_chosen_graph(self):
        ...
        try:
            if choice.startswith("Diagrama"):
                ...
                # reuse results plot - power flows by using net.res_line p_from_mw
